...
import stdof.pgb.generic.component.FilterParam;
...
import stdof.pgb.functional.component.DateFilterCriteria;
import stdof.pgb.functional.component.DateRangeFilterCriteria;
import stdof.pgb.functional.component.FilterCriteria;
import stdof.pgb.functional.component.ListOfStringsFilterCriteria;
import stdof.pgb.functional.component.NumberFilterCriteria;
import stdof.pgb.functional.component.ObjectFilterCriteria;
    ...
    private static FilterCriteria createFilterCriteria(FilterParam filterParam,
        ...
        if ("text".equalsIgnoreCase(filterType)) {
            ...
            try {
                ...
                CommonLogger.log(QueryHelper.class, "Date Range filter params processing error - ", ex);
        ...
        if(searchCriteria!=null) {
            ...
            CommonLogger.log(QueryHelper.class, "filterKey:" + key);
